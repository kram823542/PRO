...
//             <button onClick={fetchReport} className="btn-primary flex-1">
//               View Report
//             </button>
//             <button onClick={downloadExcel} className="btn-success flex-1">
//               📥 Excel
//             </button>
//           </div>
//         </div>
...
//                 <p className="text-xl font-bold">{reportData.totalEmployees}</p>
//               </div>
//             </div>
//           </div>

//           {reportData.reportData?.map((emp) => (
//             <div key={emp.employee.id} className="card">
//               <div className="flex justify-between mb-3">
//                 <div>
//                   <h3 className="font-bold text-primary">{emp.employee.name}</h3>
//                   <p className="text-xs text-gray-500">
//                     {emp.employee.employeeType} • {emp.employee.userId}
//                   </p>
//                 </div>
//               </div>
...
//                   <p className="font-bold text-green-600">{emp.present}</p>
//                 </div>
//                 <div className="bg-red-50 p-2 rounded">
//                   <p className="text-xs text-gray-600">Absent</p>
//                   <p className="font-bold text-red-600">{emp.absent}</p>
//                 </div>
//                 <div className="bg-yellow-50 p-2 rounded">
//                   <p className="text-xs text-gray-600">Pending</p>
//                   <p className="font-bold text-yellow-600">{emp.pending}</p>
//                 </div>
//                 <div className="bg-gray-100 p-2 rounded">
//                   <p className="text-xs text-gray-600">Total</p>
//                   <p className="font-bold text-primary">{emp.total}</p>
//                 </div>
//               </div>
//             </div>
//           ))}
...
//         <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-black">Reports</h1>
...
//             <button
//               onClick={fetchReport}
//               className="bg-black hover:bg-neutral-800 text-white font-semibold py-2.5 flex-1 rounded-xl shadow-sm transition-all active:scale-95 text-sm"
//             >
//               View Report
//             </button>
//             <button
//               onClick={downloadExcel}
//               className="bg-white hover:bg-neutral-100 text-black border border-black font-semibold py-2.5 flex-1 rounded-xl shadow-sm transition-all active:scale-95 text-sm flex items-center justify-center gap-1"
//             >
//               📥 Excel
//             </button>
//           </div>
...
//           {/* Summary Card */}
//           <div className="bg-white border border-black p-6 rounded-2xl shadow-sm">
//             <h2 className="font-bold text-xl text-black mb-4 pb-3 border-b border-neutral-200">
//               {reportData.clf?.name} — {MONTHS[month - 1]} {year}
//             </h2>
...
//               className="bg-white border border-black p-5 rounded-2xl shadow-sm"
//             >
//               <div className="flex justify-between items-start mb-4 pb-2 border-b border-neutral-100">
//                 <div>
//                   <h3 className="font-bold text-black text-lg">{emp.employee.name}</h3>
...
//                 <div className="bg-white border border-black p-3 rounded-xl">
//                   <p className="text-xs font-bold text-black uppercase tracking-wider">
//                     Present
//                   </p>
//                   <p className="text-xl font-black text-black mt-1">{emp.present}</p>
//                 </div>
//                 <div className="bg-neutral-100 border border-neutral-300 p-3 rounded-xl">
//                   <p className="text-xs font-bold text-neutral-700 uppercase tracking-wider">
//                     Absent
//                   </p>
//                   <p className="text-xl font-bold text-neutral-900 mt-1">{emp.absent}</p>
//                 </div>
//                 <div className="bg-neutral-100 border border-neutral-300 p-3 rounded-xl">
//                   <p className="text-xs font-bold text-neutral-700 uppercase tracking-wider">
//                     Pending
//                   </p>
//                   <p className="text-xl font-bold text-neutral-900 mt-1">{emp.pending}</p>
//                 </div>
