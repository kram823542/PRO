...
//                     <strong>Date:</strong> {format(new Date(sub.date), 'dd MMM yyyy')}
//                   </p>
//                   <p className="text-sm text-gray-700 mb-1">
//                     <strong>Work Type:</strong> {sub.workType}
//                   </p>
//                   <p className="text-sm text-gray-700 mb-4">{sub.description}</p>
...
//                     <button
//                       onClick={() => setSelected(sub)}
//                       className="text-sm bg-gray-200 hover:bg-gray-300 text-primary px-4 rounded-lg font-semibold"
//                     >
//                       View Photo
//                     </button>
//                   </div>
...
//               <p>
//                 <strong>Date:</strong> {format(new Date(selected.date), 'dd MMM yyyy')}
//               </p>
//               <p>
//                 <strong>Type:</strong> {selected.workType}
//               </p>
//               <p>
