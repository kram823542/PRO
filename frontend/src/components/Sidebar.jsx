...
// const AddExpenseModal = ({ isOpen, onClose, onSubmit, formData, setFormData }) => {
...
//       {/* Main Modal Container - Pure Dark Theme */}
//       <div className="w-full max-w-3xl bg-zinc-900 border border-zinc-800 text-zinc-100 rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
...
//                 className="w-full bg-zinc-900 border border-zinc-700 text-white rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer"
//               />
//             </div>
//           </div>

//           {/* VENDOR & DETAILS SECTION */}
//           <div className="bg-zinc-800/60 p-4 rounded-lg border border-zinc-700/50 space-y-4">
...
//                   onChange={handleChange}
//                   className="w-full bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-500 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
//                 />
//               </div>
...
//                   onChange={handleChange}
//                   className="w-full bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-500 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono"
//                 />
//               </div>
//             </div>
...
//                   onChange={handleChange}
//                   className="w-full bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-500 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono uppercase"
//                 />
//               </div>
//             </div>
...
//                 onChange={handleChange}
//                 className="w-full bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-500 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-bold"
//               />
//             </div>
...
//             type="button"
//             onClick={onSubmit}
//             className="px-5 py-2 rounded-lg text-sm font-medium bg-blue-600 hover:bg-blue-500 text-white transition-colors shadow-lg shadow-blue-600/20"
//           >
//             Add Expense
//           </button>
//         </div>
